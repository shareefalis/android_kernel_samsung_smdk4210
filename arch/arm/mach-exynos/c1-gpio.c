...
#if defined(CONFIG_TARGET_LOCALE_NA)
	{
		.num	= EXYNOS4210_GPE1(6),	/*wimax EEP_SEL*/
		.cfg	= S3C_GPIO_OUTPUT,
		.val	= S3C_GPIO_SETPIN_ONE,
		.pud	= S3C_GPIO_PULL_UP,
		.drv	= S5P_GPIO_DRVSTR_LV4,
	}, {
		.num	= EXYNOS4210_GPE2(2),	/* VT_CAM_1.5V_EN*/
		.cfg	= S3C_GPIO_OUTPUT,
		.val	= S3C_GPIO_SETPIN_ZERO,
		.pud	= S3C_GPIO_PULL_NONE,
		.drv	= S5P_GPIO_DRVSTR_LV4,
	}, {
		.num    = EXYNOS4210_GPJ0(0),  /* GPIO_CAM_PCLK*/
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num    = EXYNOS4210_GPJ0(1),  /* GPIO_CAM_VSYNC*/
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num	= EXYNOS4210_GPJ0(2),	/* GPIO_CAM_HSYNC */
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num	= EXYNOS4210_GPJ0(3),	/* GPIO_CAM_D0 */
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num	= EXYNOS4210_GPJ0(4),	/* GPIO_CAM_D1 */
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num	= EXYNOS4210_GPJ0(5),	/* GPIO_CAM_D2 */
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num	= EXYNOS4210_GPJ0(6),	/* GPIO_CAM_D3 */
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num	= EXYNOS4210_GPJ0(7),	/* GPIO_CAM_D4 */
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num	= EXYNOS4210_GPJ1(0),	/* GPIO_CAM_D5 */
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num	= EXYNOS4210_GPJ1(1),	/* GPIO_CAM_D6 */
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
	}, {
		.num	= EXYNOS4210_GPJ1(2),	/* GPIO_CAM_D7 */
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
		.drv	= S5P_GPIO_DRVSTR_LV1,
...
static unsigned int u1_sleep_gpio_table[][3] = {
	...
	{ EXYNOS4_GPA0(7),	S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, /* NC */
#else
#if defined(CONFIG_MACH_C1_NA_SPR_EPIC2_REV00)
	{ EXYNOS4_GPA0(6),	S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* KEY_EXPANDER_SDA */
	{ EXYNOS4_GPA0(7),	S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* KEY_EXPANDER_SCL */
#else
...
#if defined(CONFIG_TARGET_LOCALE_NA)
	{ EXYNOS4210_GPE3(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(0) */
	{ EXYNOS4210_GPE3(1),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(1) */
	{ EXYNOS4210_GPE3(2),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(2) */
	{ EXYNOS4210_GPE3(3),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(3) */
	{ EXYNOS4210_GPE3(4),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(4) */
	{ EXYNOS4210_GPE3(5),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(5) */
	{ EXYNOS4210_GPE3(6),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(6) */
	{ EXYNOS4210_GPE3(7),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(7) */

	{ EXYNOS4210_GPE4(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(8) */
	{ EXYNOS4210_GPE4(1),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(9) */
	{ EXYNOS4210_GPE4(2),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(10) */
	{ EXYNOS4210_GPE4(3),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(11) */
	{ EXYNOS4210_GPE4(4),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(12) */
	{ EXYNOS4210_GPE4(5),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(13) */
	{ EXYNOS4210_GPE4(6),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(14) */
	{ EXYNOS4210_GPE4(7),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},  /* EBI2_AD(15) */
