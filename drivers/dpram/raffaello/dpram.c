...
static long dpram_dump_ioctl(struct file *file,
...
{
#ifdef DEBUG_DPRAM_INT_HANDLER
    LOGA("dpram_wake_from_CP_irq_handler: wake_lock_timeout() in 5 seconds.\n");
#endif
...
static int kernel_sec_dump_cp_handle2(void)
{
    ...
    // output high
	gpio_set_value(EXYNOS4_GPE0_3_MDM_IRQn, GPIO_LEVEL_HIGH);

    // GPIO output mux
	s3c_gpio_cfgpin(EXYNOS4_GPE0_0_MDM_WEn, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE0_1_MDM_CSn, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE0_2_MDM_Rn, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE0_3_MDM_IRQn, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE0_4_MDM_ADVN, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
...
static int register_dpram_driver(void)
{
    ...
    if (retval) {
        LOGE("tty_register_driver error %i\n", retval);
...
static int vs_ioctl(struct tty_struct *tty, unsigned int cmd, unsigned long arg)
{
    return -ENOIOCTLCMD;
}
...
//__raw_writel(__raw_readl(S5PV210_EINT1FLTCON0)|(FILTER_EINT9_EN & (~FILTER_EINT9_SEL_DEGIT)),S5PV210_EINT1FLTCON0);
	...
	s3c_gpio_cfgpin(EXYNOS4_GPE3_0_MDM_DATA_0, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE3_1_MDM_DATA_1, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE3_2_MDM_DATA_2, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE3_3_MDM_DATA_3, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE3_4_MDM_DATA_4, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE3_5_MDM_DATA_5, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE3_6_MDM_DATA_6, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE3_7_MDM_DATA_7, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));

	s3c_gpio_cfgpin(EXYNOS4_GPE4_0_MDM_DATA_8, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE4_1_MDM_DATA_9, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE4_2_MDM_DATA_10, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE4_3_MDM_DATA_11, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE4_4_MDM_DATA_12, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE4_5_MDM_DATA_13, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE4_6_MDM_DATA_14, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
	s3c_gpio_cfgpin(EXYNOS4_GPE4_7_MDM_DATA_15, S3C_GPIO_SFN(EXYNOS4_MDM_IF_SEL));
...
static int dpram_suspend(struct platform_device *dev, pm_message_t state)
{
    ...
    */
    ...
    else
    {
        ...
        LOGA("Skip the suspend mode - read lock \n");
		g_dpram_wpend = IDPRAM_WPEND_UNLOCK; // dpram write unlock
        return -1;
    }
